...
//    public void setUpClass( @Optional("iOS") String platformName, @Optional("943E6A5B-51D7-4C0C-9EC5-6201CF108E95")String udid, @Optional("iPhone 14 Pro Max")String deviceName, @Optional("7272727272")String mobileNumber, @Optional("TEST")String environmentType) throws Exception {
