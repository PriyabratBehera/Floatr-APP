...
public class DigitalGoldPage extends ProfilePage {
    ...
    private MobileElement sendGiftOTP1;
    ...
    @AndroidFindBy(xpath = "//*[@text='Investment Amount']/following-sibling::android.view.ViewGroup[1]//android.widget.EditText")
    ...
    @AndroidFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Transaction History\"]/following-sibling::XCUIElementTypeOther[2]/descendant::XCUIElementTypeOther[3]/descendant::XCUIElementTypeStaticText[2]")
    ...
    @AndroidFindBy(xpath = "//*[@text='Add New']/following-sibling::android.view.ViewGroup/child::android.view.ViewGroup/android.widget.TextView")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"In process\"]")
...
private MobileElement bikeGoal;
    ...
    public void clickEllipsisGoal(String goalType) throws Exception {
        ...
        if (Objects.equals(params.getPlatformName(), "iOS")) {
            xpath = "(//XCUIElementTypeOther[@name='" + goalType + "'])[1]/XCUIElementTypeOther[3]";
        } else {
...
//                        "    \"contact\": \"9585034203\",\n" +
    ...
    public void enterOTPSellGold() {
        ...
        sendKeys(sendGiftOTP1, String.valueOf(otp.charAt(0)));
...
//                scrollElement(goalBasedInvesting, "up", setFinancialGoal);
    ...
    public void clickView() throws Exception {
        for (int i = 0; i < 5; i++) {
            if (new BasePage().isVisible(viewInTransactionHistory)) {
                break;
            } else {
                new MutualFundPage().scrollDown();
            }
        }
...
//
    ...
    public void clickRemoveButton() throws Exception {
        if (isVisible(cartIsEmpty)) {
            ...
            Thread.sleep(2000);
            clickByTextContains("1.00 gm Gold coin");
            clickByText("Buy Now");
        }
...
//        Assert.assertEquals(transactionamount.getText(),transactionAmount);
    ...
    public void scrollFaqSec() throws Exception {
        scrollElement(faqSection,"up",lockerShellGift,3000,10);
    }
    public void scrollTwentyFourExtra() throws Exception {
        scrollElement(twentyFourExtra,"up",hundredFourPerExtra,3000,10);
    }
    public void scrollWhenIsExtra() throws Exception {
        scrollElement(whenIsExtra,"up",twentyFourExtra,3000,10);
    }
