...
public class BasePage {
    ...
    public void clickDoneWithHomeKey() {
...
//                startY = (int) (size.height * 0.4);
    ...
    public MobileElement scrollElement(MobileElement element, String direction, MobileElement refElement) throws Exception {
        Dimension size = driver.manage().window().getSize();
        int startX = (int) (size.width * 0.5);
        int endX = (int) (size.width * 0.5);
        int startY = 0;
...
//                startY = (int) (size.height * 0.4);
    ...
    public MobileElement scrollElement(MobileElement element, String direction, MobileElement refElement,int speed,int time) throws Exception {
        Dimension size = driver.manage().window().getSize();
        int startX = (int) (size.width * 0.5);
        int endX = (int) (size.width * 0.5);
        int startY = 0;
...
//                startY = (int) (size.height * 0.4);
    ...
    public MobileElement scrollElement(MobileElement element, String direction, MobileElement refElement,int speed) throws Exception {
        Dimension size = driver.manage().window().getSize();
        int startX = (int) (size.width * 0.5);
        int endX = (int) (size.width * 0.5);
        int startY = 0;
...
//                startY = (int) (size.height * 0.4);
    ...
    public void clickEnterOnKeyboard() throws Exception {
        String xpath = "//XCUIElementTypeButton[@name='Return']";
        clickIfExist(getElement(xpath));
    }

    public void clickButtonTextDone() throws Exception {
