...
//        }
        ...
        scrollElement(goalBasedInvesting,"up",setFinancialGoal,2000);
    }
    ...
    public void scrollToViewWhereIShouldInvest() throws Exception {
        ...
        scrollElement(whereIShouldInvest, "up", howShouldIStart,3000,10);
    }
...
//        }
    ...
    public void scrollToAuthenticateAndSave() throws Exception {
        ...
        scrollElement(AuthenticateAndSave, "up", createSIP,3000,10);
    }
