...
public class NpsInvestmentPage extends ProfilePage {
    ...
    @AndroidFindBy(xpath = "//*[@text=\"1995\"]")
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeOther[@name=\"1995\"])[1]")
...
//                scrollInAndroid(buyInsurance, 202, 796, 194, 461);
    ...
    public void scrollToMoreAboutNps() throws Exception {
        if (Objects.equals(globalParams.getPlatformName(), "Android")) {
            ...
            scrollElement(moreAboutNps, "up", taxBenefitsNPS);
        }
    }
...
//            andScrollToElementUsingUiScrollable("text","Auto Choice of Investment");
            ...
            scrollElement(autoChoiceInvest, "up", npsAdvantages, 5000);
        }
    }
...
//            scrollInAndroid(taxSavingAccount, 204, 793, 201, 252);
    ...
    public void scrollToNpsFaq() throws Exception {
        scrollElement(npsFaq, "up", autoChoiceInvest);
    }
...
//            scrollInAndroid(currentAge,  201, 252,204, 793);
            ...
            scrollElement(currentAge, "down", retirementSavingPlan);
...
//            scrollInAndroid( 887, 1512, 177, 1504);
    ...
    public void enterGuardianDob() throws Exception {
        ...
        if (Objects.equals(globalParams.getPlatformName(), "Android")) {
            ...
            scrollElement(dt1998, "up", dtPicker, 20000);
            click(dt1998);
        }
        clickByText("1");
        clickByText("OK");
...
//        }
    ...
    public void enterPranNumber(String pranNuber) throws Exception {
        ...
        if (Objects.equals(globalParams.getPlatformName(), "iOS")) {
            ...
            clickStaticText("Check PRAN Status");
        }
    }
