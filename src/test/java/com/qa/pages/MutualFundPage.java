...
public class MutualFundPage extends ProfilePage {
    ...
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeOther[@name=\"Mutual\n" +
            "Funds\"])[2]")
    @AndroidFindBy(xpath = "//*[contains(@text,'Mutual')]")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeOther[@name='Add External Folios Investments done outside Floatr App']")
    @AndroidFindBy(xpath = "//*[@text='Add External Folios']")
    private MobileElement addExternalFolio;

    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Lockin Applicable']")
    @AndroidFindBy(xpath = "//*[@text='Lockin Applicable']")
    private MobileElement lockinPeriod;
    ...
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[contains(@name,\"Aditya Birla Sun Life Frontline Equity Fund (G)\")])[2]/parent::XCUIElementTypeOther/following-sibling::XCUIElementTypeOther")
    ...
    private MobileElement purchaseOTP1;
    ...
    @iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[contains(@name,\"ADITYA BIRLA SUN LIFE SHORT TERM FUND - GROWTH\")])[2]/parent::XCUIElementTypeOther/following-sibling::XCUIElementTypeOther")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeOther[@name='Start Date']//following-sibling::XCUIElementTypeOther")
    ...
    public void selectFolioNumber(String text1, String text2) throws Exception {
        String xpath = "";
        if (getElement("//XCUIElementTypeStaticText[@name=\"Folio Number\"]/following-sibling::XCUIElementTypeOther/XCUIElementTypeStaticText").getText().equals("Select") || getElement("//*[@text='Folio Number']/following-sibling::android.view.ViewGroup[1]/android.widget.TextView").getText().equals("Select")) {
            clickFolioNumberBox();
    ...
    public void enterPurchaseOtp() throws Exception {
        if (isVisible(purchaseOTPText)) {
            ...
            sendKeys(purchaseOTP1, String.valueOf(otp.charAt(0)));
...
//        click(mutualFunds);
    ...
    public void enterMutualFund(String mutualFundName) {
...
//        scrollToElement(equity, "up", viewAll);
        if(Objects.equals(globalParams.getPlatformName(),"Android")){
            andScrollToElementUsingUiScrollable("text","Add External Folios");
        }
        else{
...
//        scrollToElement(lockinPeriod, "up", minSwitch);
        if(Objects.equals(globalParams.getPlatformName(),"Android")){
//            andScrollToElementUsingUiScrollable("text","Lockin Period");
    ...
    public void clickAddToCartForDifferentSchemes() throws InterruptedException {
        if (Objects.equals(globalParams.getPlatformName(), "iOS")) {
            ...
            while (!isVisible(youCanAdd4OnlySchemesPopup)) {
                clickIfExist(firstMF);
//                if(isVisible(youCanAdd4OnlySchemesPopup)){
//                    break;
//                }
            }
        }
...
//            }
    ...
    public void clickThreeDotInMySip() throws Exception {
//        if(Objects.equals(globalParams.getPlatformName(),"Android")){
//            andScrollToElementUsingUiScrollable("text","Installments  2/36");
//        }
//        else{
//            iOSScrollToElementByName(twoInstallmentOf,"up","Installments  2/36");
//        }
    ...
    public void enterFolioNo(String text) throws Exception {
        clear(folioNumberBoxAddExScreen);
//        sendKeys(folioNumberBoxAddExScreen, "1");
//        click(folioNumberBoxAddExScreen);
//        click(selectAll);
//        click(cut);
        sendKeys(folioNumberBoxAddExScreen, text);
        if (Objects.equals(globalParams.getPlatformName(), "iOS")) {
    ...
    public void clickProcessTransactionHistory() throws InterruptedException {
    ...
    public void clickCloseIconForAllSchemes() {
        for (int i = 0; i < 5; i++) {
...
//        sendKeys(partialFundAmountBox, "1");
...
//        click(cut);
        ...
        if (Objects.equals(globalParams.getPlatformName(), "iOS")) {
            {
                new BasePage().clickButtonTextDone();
            }
        }
    }
...
//            enterMutualFund("Aditya");
    ...
    public void scrollToMinStpInst() throws Exception {
        if (Objects.equals(globalParams.getPlatformName(), "Android")) {
//            andIosScroll(minStpInstMon, "up", lockinPeriod);
            andScrollToElementUsingUiScrollable("text","Min. STP Installments (Monthly)");

        } else {
            andIosScroll(minStpInstMon, "up", lockinPeriod,4000);
//            iOSScrollToElementByName(minStpInstMon,"up","Min. STP Installments (Monthly)");
        }
    }
    ...
    public void removeSchemeSwiScv(String schemeName) throws Exception {
        ...
        if(Objects.equals(globalParams.getPlatformName(),"Android")){
            ...
            xpath="//*[@text='"+schemeName+"']/following-sibling::android.view.ViewGroup";
        }
        click(getElement(xpath));
    }
