...
public class MutualFundPage extends ProfilePage {
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[contains(@name,'Start Date')]/following-sibling::XCUIElementTypeStaticText[1]")
    private MobileElement stpStartDate;
    @AndroidFindBy(xpath = "//*[contains(@text,'Start Day')]/following-sibling::android.view.ViewGroup[1]")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[contains(@name,'Start Day')]/following-sibling::XCUIElementTypeStaticText[1]")
    private MobileElement swpStartDate;
    @AndroidFindBy(xpath = "//*[@text='Number of Transfer']/following-sibling::android.widget.EditText")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Number of Transfer']/following-sibling::XCUIElementTypeStaticText")
    private MobileElement numOfTransfer;
    @AndroidFindBy(xpath = "//*[@text='SWP Duration']/following-sibling::android.widget.EditText")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='SWP Duration']/following-sibling::XCUIElementTypeStaticText")
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Withdrawal Amount']/following-sibling::XCUIElementTypeStaticText")
