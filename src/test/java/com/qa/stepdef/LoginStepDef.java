...
public class LoginStepDef {
    ...
    public void userEntersMobileNumberAs(String mobileNo) {
    ...
    public void userShouldSeeHomePageWithProfileName(String profileName) {
    ...
    public void userLoginToApp() throws InterruptedException {
        new LoginPage().login("", "");
    }
