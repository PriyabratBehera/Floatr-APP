...
Feature: Create Budget Scenarios
  ...
  Scenario: Verify budget tab is functional
    ...
    And user verify partial static text "2023"
    ...
    And user verify static text "View your financial reports"
    And user verify static text "Know where your money goes"
  ...
  Scenario: Verify validation in create budget screen
    Given user clean up the app data for "9191787806 | 9191787806"
#    And user login with user "9191787807 | 9191787806"
    And application launched successfully
    When user clicks on Budget
    And user wait for "2000" milli second
...
#    And user login with user "9191787806 | 9191787806"
    ...
    And user verify static text "How much will you save & invest?"
    ...
    And user verify static text "Select"
...
#    And user login with user "9191787806 | 9191787806"
  ...
  Scenario: Verify My Budget screen after creating budget
  ...
  Scenario: Verify Create budget screen after creating budget
    Given application launched successfully
    When user clicks on Budget
    And user wait for "2000" milli second
    And user click by text "Create Budget"
